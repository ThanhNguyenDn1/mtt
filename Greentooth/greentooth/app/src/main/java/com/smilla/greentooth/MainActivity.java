...
public class MainActivity extends AppCompatActivity implements DelayFragment.DelayInterface {
  ...
  preDisableNotificationsSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
      @Override
      public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
          ...
          {
              if(preDisableNotificationsSwitch.isChecked()){
                  Toast.makeText(getApplicationContext(), "You need to update to premium version", Toast.LENGTH_SHORT).show();
                  preDisableNotificationsSwitch.setChecked(false);
              }
          }
