...
public class HowToUseThisDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View v = mInflater.inflate(R.layout.dialog_how_to_use_this, null);
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            throw new ClassCastException(context.toString() + "must implement HowToUseThisDialog listener"); // This will throw if no correct listner is implemented in Activity
        }
    }
