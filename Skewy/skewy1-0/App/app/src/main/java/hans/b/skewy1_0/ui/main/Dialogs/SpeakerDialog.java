...
public class SpeakerDialog extends DialogFragment {
    ...
    private ImageView imageViewClipKlein;
    private ImageView imageViewGummiKlein;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View v = mInflater.inflate(R.layout.dialog_speaker, null);

        mBuilder.setView(v) // Passing the view to the dialog which is build
                .setTitle("Use a speaker")
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            throw new ClassCastException(context.toString() + "must implement SpeakerDialogListener"); // This will throw if no SlmDialaogListner is implemented in Activity
        }
    }
