...
public class PrivacyDataDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View v = mInflater.inflate(R.layout.dialog_privacy_data, null);




        mBuilder.setView(v) // Passing the view to the dialog which is build
                .setTitle("Privacy policy and data")
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            throw new ClassCastException(context.toString() + "must implement AboutDialogListener"); // This will throw if no SlmDialaogListner is implemented in Activity
        }
    }
}
