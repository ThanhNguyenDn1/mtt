    ...
    public View onCreateView(
        ...
        switch_recorder.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                {
                    if(switch_recorder.isPressed()){
                        if(switch_recorder.isChecked()){
                            Toast.makeText(getContext(), "You need to update to premium version", Toast.LENGTH_SHORT).show();
                            switch_recorder.setChecked(false);
                        }
                    }
                }
