...
public class HelpDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View v = mInflater.inflate(R.layout.dialog_help, null);
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            throw new ClassCastException(context.toString() + "must implement HelpDialogListener"); // This will throw if no SlmDialaogListner is implemented in Activity
        }
    }
}
